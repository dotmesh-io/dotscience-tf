...
resource "google_compute_instance" "dotscience_hub_vm" {
 ...
 boot_disk {
   initialize_params {
     image = "dotscience-images/dotscience-hub-1580477793"
   }
 }
